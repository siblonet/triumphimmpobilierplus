const Ventedata = async (listing_data) => {
    listing_data.innerHTML += `
        <div class="card--container" style="margin-top: 20px;">
        <div class="app-content-header">
            <h3 class="main--title" id="datalengthvente">En ventes</h3>
    ...
    document.getElementById('datalengthvente').innerText = `(${houses.length}) Maison${houses.length > 1 ? "s" : ""} En ventes`;
